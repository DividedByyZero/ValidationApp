...
function validate(e){
    ...
    if(search==2){
        if(x.value.match(phoneRegex)){
            alert(`${x.value} is a valid Bangladeshi Phone Number!`);
        }
        else{
            alert(`${x.value} is not a valid Bangladeshi Phone Number !`);
        }
        
    }
    if(search==3){
        if(x.value.match(postRegex)){
            alert(`${x.value} is a valid Bangladeshi Postal Code!`);
        }
        else{
            alert(`${x.value} is not a valid Bangladeshi Postal Code !`);
        }
    }
    e.preventDefault();
}
